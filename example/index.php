...
$app::$Routing->add("*",function ($app){ $app->set("ALWAYS_RUNNING","Always running"); });//minden oldal
$app::$Routing->add("script",function ($app){ $app->set("ALWAYS_RUNNING","Always running"); },"cli");//minden oldal
...
$app::$Routing->add("/product/{productname}.html",function ($id,$id2){ echo $id."\n"; echo $id2;});//regexes
